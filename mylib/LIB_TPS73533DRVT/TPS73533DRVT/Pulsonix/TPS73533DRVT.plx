...
//252043/1707663/2.50/7/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS73533DRVT" (originalName "TPS73533DRVT")
	...
	(compDef "TPS73533DRVT" (originalName "TPS73533DRVT") (compHeader (numPins 7) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "OUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "NR") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS73533DRVT"))
		...
		(attr "Mouser Part Number" "595-TPS73533DRVT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS73533DRVT?qs=IDSsxkoac0yfD47GOItrRw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS73533DRVT")
		(attr "Description" "500mA 3.3V Low IQ/Noise LDO Reg. WSON6EP TPS73533DRVT, Low Dropout Voltage Regulator, 500mA, 1  4.3 V +/-1%, 6-Pin SON")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tps735.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "TPS73533DRVT.stp")
