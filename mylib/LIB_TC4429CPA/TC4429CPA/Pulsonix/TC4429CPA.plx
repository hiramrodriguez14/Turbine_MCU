...
//4567320/1707663/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TC4429CPA" (originalName "TC4429CPA")
	...
	(compDef "TC4429CPA" (originalName "TC4429CPA") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "VDD_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "__OUTPUT_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__OUTPUT_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TC4429CPA"))
		...
		(attr "Mouser Part Number" "579-TC4429CPA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/TC4429CPA?qs=YUl711QUJY38xt9BogTiMQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "TC4429CPA")
		(attr "Description" "IC,Driver Interface,MOSFET,IGBT,TC4429CPA")
		(attr "<Hyperlink>" "https://ww1.microchip.com/downloads/en/DeviceDoc/21419D.pdf")
		(attr "<Component Height>" "4.32")
		(attr "<STEP Filename>" "TC4429CPA.stp")
